...
import {APIService, EventModel, SigninCodeModel} from '../../services/api.service';
...
export class EventCodeSigninComponent implements OnInit, AfterViewInit {
  ...
  async ngOnInit() {
    this.expireInSubscription = interval(1000).subscribe(() => this.updateExpireIn());
